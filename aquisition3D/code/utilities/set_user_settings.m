...
handles.baslerCam.Parameters.Item('CenterX').SetValue(handles.acqSettings.centerX); % logical
handles.baslerCam.Parameters.Item('CenterY').SetValue(handles.acqSettings.centerY); % logical
...
% Get updated sensor size (should contrain values)
